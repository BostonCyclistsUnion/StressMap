...
CREATE INDEX IF NOT EXISTS WAY_CITY_IDX ON WAY(CITY_ID);
CREATE INDEX IF NOT EXISTS WAY_NAME_IDX ON WAY(WAY_NAME);
CREATE INDEX IF NOT EXISTS WAY_HIGHWAY_IDX ON WAY(HIGHWAY);
...
CREATE INDEX IF NOT EXISTS WAY_NODE_IDX ON WAY_NODE(WAY_OSM_ID, NODE_OSM_ID);
CREATE UNIQUE INDEX IF NOT EXISTS WAY_NODE_UIDX ON WAY_NODE(WAY_OSM_ID, NODE_OSM_ID, POSITION);
...
CREATE TABLE IF NOT EXISTS WAY_RELATION
(
    WAY_OSM_ID          INTEGER NOT NULL REFERENCES WAY(OSM_ID),
    RELATION_OSM_ID     INTEGER NOT NULL REFERENCES RELATION(OSM_ID)
);

CREATE INDEX IF NOT EXISTS WAY_RELATION_IDX ON WAY_RELATION(WAY_OSM_ID, RELATION_OSM_ID);
CREATE UNIQUE INDEX IF NOT EXISTS WAY_RELATION_UIDX ON WAY_RELATION(WAY_OSM_ID, RELATION_OSM_ID);